...
class PrometheusProvider(Object):
    ...
    def __init__(self, charm, relation_name, port, path, **job_data):
        ...
        If you wish to overwrite individual fields like "honor_timestamps", you
        can add your own value for it as a keyword argument. Just make sure all
        keyword arguments are valid keys in the prometheus configuration files.
        """
